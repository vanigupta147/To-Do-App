...
#Button widget 
entry_button=Button(window,text="Add task",bg="black",fg="white",width=30,command=entertask)
entry_button.pack(pady=3)

delete_button=Button(window,text="Delete selected task",bg="black",fg="white",width=30,command=deletetask)
delete_button.pack(pady=3)

mark_button=Button(window,text="Mark as completed ",bg="black",fg="white",width=30,command=markcompleted)
